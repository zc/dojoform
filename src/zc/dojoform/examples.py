...
class Calculator(zc.ajaxform.calculator_example.Calculator):
    ...
    def template(self):
        return """<html><head>
               <style type="text/css">@import "http://o.aolcdn.com/dojo/1.3.0/dijit/themes/tundra/tundra.css";</style>
...
class Form(zc.ajaxform.form_example.FormExample):
    ...
    def template(self):
        return """<html><head>
               <style type="text/css">
               @import "http://o.aolcdn.com/dojo/1.3.0/dijit/themes/tundra/tundra.css";</style>
               <script type="text/javascript" src="http://o.aolcdn.com/dojo/1.3.0/dojo/dojo.xd.js"></script>
               <script type="text/javascript" src="/@@/zc.dojoform/zc.dojo.js"></script>
